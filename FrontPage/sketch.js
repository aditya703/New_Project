...
function draw() {
	//checking whether the player is at home or any other page
	if(gameState === 'home'){	
	...
	// checking whether the user clicked on the credit button
	...
	//checking whether the user clicked to go back to the home page
	...
	//checking whether the user clicked on the play button.
